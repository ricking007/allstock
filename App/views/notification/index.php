                ...
                <div class="box-body">
                  <table class="table table-hover table-list">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr class="<?php echo $n['id_status'] == 1 ? 'text-bold' : ''?> dblclick" data-notification="<?php echo $n['id_notificacao'] ?>">
                            ...
                            <td><?php echo $n['id_pessoa'] == $this->getUser('id_pessoa') ? 'Você' : $n['no_lida_por'] ?></td>
